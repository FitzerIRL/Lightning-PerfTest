...
class NoopMediaplayer extends lightning$1.Component {
...
class ScaledImageTexture extends lightning$1.textures.ImageTexture {
    ...
    set scalingOptions(options) {
        if (!lightning$1.Utils.equalValues(this._scalingOptions, options)) {
    ...
    static _convertScalingOptions(options) {
        const opts = lightning$1.Utils.clone(options);
        switch(options.type) {
            case "crop":
                opts.type = "cover";
                break;
    ...
    _getImageServerSrc(src) {
        if (this._scalingOptions && (this._precision !== 1)) {
            const opts = lightning$1.Utils.clone(this._scalingOptions);
            if (opts.width) {
    ...
    static _getCdnProtocol() {
        return lightning$1.Utils.isWeb && location.protocol === "https:" ? "https" : "http";
    }
...
class Ui extends lightning$1.Application {
    ...
    static _template() {
        ...
        if (lightning$1.Utils.isWeb) {
            mediaPlayerType = Mediaplayer;
        }
        else if (lightning$1.Utils.isSpark) {
            mediaPlayerType = lightning$1.Stage.platform.createMediaPlayer();
        }
                    ...
                    return [
                        class Loading extends this {
                            ...
                            _startApp(appClass) {
                                ...
                                let fn = lightning$1.Utils.isWeb ? Ui.loadFonts(fonts): this.loadPlatformFonts(fonts);
                                fn.then((fontFaces) => {
...
class PlayerButton extends lightning$1.Component {

    static _template() {
        const o = this.options;
        return {
            w: o.w, h: o.h,
            Background: {x: -1, y: -1, texture: lightning$1.Tools.getRoundRect(o.w, o.h, 4, 0, 0, true), color: o.colors.deselected},
...
class PlayerControls extends lightning$1.Component {
...
class PlayerProgress extends lightning$1.Component {
    ...
    static _template() {
        return {
            Progress: {
                forceZIndexContext: true,
                Total: {
                    x: -1, y: -1, texture: lightning$1.Tools.getRoundRect(1720, 10, 4), color: 0xFF606060,
                    Scroller: {
                        x: 0, y: 6, mount: 0.5, w: 16, h: 16, zIndex: 2,
                        Shadow: {
                            texture: lightning$1.Tools.getShadowRect(16, 16, 8),
                            mount: 0.5,
                            x: 8,
                            y: 8,
                            color: 0xFF000000
                        },
                        Main: {texture: lightning$1.Tools.getRoundRect(16, 16, 8), mount: 0.5, x: 8, y: 8, color: 0xFFF1F1F1}
                    }
                },
    ...
    _init() {
        this.tag("Active").texture = {
            type: lightning$1.textures.SourceTexture,
...
class Player extends lightning$1.Component {
...
class Light3dComponent extends lightning$1.Component {
    ...
    constructor(stage) {
        ...
        this.patch({
            ...
            Main: {
                x: -1,
                y: -1,
                shader: {type: lightning$1.shaders.Light3d, fudge: 0.3},
        ...
        this._anims = {
            neutral: this.animation({
                duration: 0.4, actions: [
                    {p: 'shaderZ0', merger: lightning$1.StageUtils.mergeNumbers, v: {0: 0, 0.5: -140, 1: -150}}
                ]
            }),
    ...
    _createAnimation(axis, sign, idx) {
        return this.animation({
            duration: 0.4, stopDuration: 0.2, actions: [
                {p: 'shaderR' + axis + idx, merger: lightning$1.StageUtils.mergeNumbers, v: {0: 0, 0.3: -0.20 * sign, 1: 0}},
                {
                    p: 'shaderZ' + idx,
                    merger: lightning$1.StageUtils.mergeNumbers,
...
class KeyboardButton extends lightning$1.Component {
    static _template() {
        return {
    ...
    _getPatch(key) {
        ...
        return {
            Background: {texture: lightning$1.Tools.getRoundRect(this.w, this.h, 7, 0, 0xffffffff, true, 0xffffffff)},
...
class ItemList extends lightning$1.Component {
    static _template() {
        return {
            Wrapper: {
                flex: {direction: 'row'}
...
class Slider extends lightning$1.Component {
    static _template() {
        return {
            Wrapper: {
                flex: {direction: 'row'}
...
class DevLauncher {
    ...
    _startApp() {
        ux$1.Ui.staticFilesPath = __dirname + "/";

        this._ui = new ux$1.Ui(this._lightningOptions);
    ...
    _getLightningOptions(customOptions = {}) {
        ...
        options = lightning$1.tools.ObjMerger.merge(options, customOptions);
...
class MyApp extends ux$1.App
{
  ...
  async doImageTests()
  {
    ...
    for(var i=0; i< IMG_ITERATIONS; i++)
    {
      ...
      if(i%10 == 0)
      {
        this.patch({ Text3: {text: PFX + "ImageLoadTime: ... "+average_ms.toFixed(2) +" ms ... (running - "+i+" of "+IMG_ITERATIONS+")"  }});
      }
    }//FOR
    // - - - - - - - - - - - - - - - - - - - - - - - - - -
...
class TextItem extends ux$1.App
{
  static _template()
  {
...
launcher.launch(MyApp, {debug:false, h:sparkscene.h}, {useInspector: false});
